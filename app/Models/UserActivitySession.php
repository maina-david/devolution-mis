 ...
 */
#[Fillable(['user_id', 'session_fingerprint', 'ip_address', 'user_agent', 'current_route', 'current_path', 'current_page_title', 'last_method', 'last_action', 'logged_in_at', 'last_seen_at', 'logged_out_at'])]
