...
return [
    ...
    'create_analytics_dashboard' => 'Create analytics dashboard', 'dashboard_code' => 'Dashboard code', 'dashboard_name' => 'Dashboard name', 'measured_value' => 'Measured value', 'no_data' => 'No data',
    ...
    'no_dashboards_description' => 'An authorized configurator can create a draft dashboard with governed metrics for independent publication.', 'no_schedules_description' => 'Create a delivery schedule against an independently published dashboard.', 'no_reports_description' => 'Approved schedules will create private checksummed report files when due or manually queued.', 'save_view_description' => 'Name the current analytics context and optionally use it as your default view.', 'save_view' => 'Save view', 'delete_saved_view' => 'Delete saved view :name', 'no_saved_views_description' => 'Apply analytics filters, then save the context for quick reuse.', 'widget_by_county' => ':title by county',
    'new_dashboard_description' => 'Start a governed draft with an allowlisted metric. A different actor must publish it.', 'new_dashboard' => 'New dashboard', 'add_widget_to_dashboard' => 'Add widget to :code', 'add_widget_description' => 'Add an allowlisted, provenance-backed metric while the dashboard remains a draft.', 'new_schedule_description' => 'Configure delivery from a published dashboard. Activation requires an independent approver.', 'new_schedule' => 'New schedule', 'actions_for_record' => 'Actions for :record', 'actions_for_report' => 'Actions for report :code',
];
