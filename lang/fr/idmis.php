...
return [
    ...
    'common' => [
        ...
        'pagination' => 'Pagination', 'previous_page' => 'Page précédente', 'previous' => 'Précédent', 'next_page' => 'Page suivante', 'next' => 'Suivant', 'toggle_sidebar' => 'Basculer la barre latérale', 'breadcrumb' => 'Fil d’Ariane', 'more' => 'Plus', 'loading' => 'Chargement', 'close' => 'Fermer',
        'settings' => 'Paramètres', 'settings_description' => 'Gérez votre profil et les paramètres de votre compte', 'hour_label' => 'Heure — :label', 'minute_label' => 'Minute — :label', 'destination_country' => 'Pays de destination', 'destination_region' => 'Comté / région de destination', 'destination_city' => 'Ville de destination', 'checking_label' => 'Vérification de :label', 'language_menu_label' => ':choose. :current : :language', 'preview_document' => 'Prévisualiser :title', 'upload_record' => 'Téléverser :record', 'update_record' => 'Mettre à jour :record', 'verify_record_progress' => 'Vérifier l’avancement de :record', 'flag_of_kenya' => 'Drapeau du Kenya', 'idmis_home' => 'IDMIS :home',
        'sidebar' => 'Barre latérale', 'mobile_sidebar_description' => 'Affiche la barre latérale mobile.',
        'verified' => 'Vérifié',
    ...
    'navigation' => [
        ...
        'monitoring_evaluation' => 'Suivi et évaluation', 'operations' => 'Opérations', 'partners' => 'Partenaires', 'performance_insights' => 'Performance et analyses', 'platform_controls' => 'Contrôles de la plateforme', 'platform_administration' => 'Administration de la plateforme', 'platform_governance' => 'Gouvernance de la plateforme', 'security_data_assurance' => 'Assurance de la sécurité et des données', 'integrations_operations' => 'Intégrations et opérations',
