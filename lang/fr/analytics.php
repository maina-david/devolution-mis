...
return [
    ...
    'create_analytics_dashboard' => 'Créer un tableau de bord analytique', 'dashboard_code' => 'Code du tableau de bord', 'dashboard_name' => 'Nom du tableau de bord', 'measured_value' => 'Valeur mesurée', 'no_data' => 'Aucune donnée',
    ...
    'no_dashboards_description' => 'Un configurateur autorisé peut créer un tableau de bord provisoire avec des indicateurs gouvernés pour publication indépendante.', 'no_schedules_description' => 'Créez un calendrier de diffusion à partir d’un tableau de bord publié indépendamment.', 'no_reports_description' => 'Les calendriers approuvés créeront des fichiers de rapport privés avec somme de contrôle à l’échéance ou lors d’une mise en file manuelle.', 'save_view_description' => 'Nommez le contexte analytique actuel et utilisez-le éventuellement comme vue par défaut.', 'save_view' => 'Enregistrer la vue', 'delete_saved_view' => 'Supprimer la vue enregistrée :name', 'no_saved_views_description' => 'Appliquez les filtres analytiques, puis enregistrez le contexte pour le réutiliser rapidement.', 'widget_by_county' => ':title par comté',
    'new_dashboard_description' => 'Démarrez un brouillon gouverné avec un indicateur autorisé. Un autre acteur doit le publier.', 'new_dashboard' => 'Nouveau tableau de bord', 'add_widget_to_dashboard' => 'Ajouter un widget à :code', 'add_widget_description' => 'Ajoutez un indicateur autorisé et traçable pendant que le tableau de bord reste en brouillon.', 'new_schedule_description' => 'Configurez la diffusion depuis un tableau de bord publié. L’activation exige un approbateur indépendant.', 'new_schedule' => 'Nouveau calendrier', 'actions_for_record' => 'Actions pour :record', 'actions_for_report' => 'Actions pour le rapport :code',
];
