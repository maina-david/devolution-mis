...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "text-sidebar-foreground pointer-events-none absolute top-1/2 right-1 mt-0.5 flex h-5 min-w-5 -translate-y-1/2 items-center justify-center rounded-md px-1 text-xs leading-none font-medium tabular-nums select-none",
